class Carousel {
    ...
    */
    ...
    preloadImages() {
        this.config.imgs.forEach(img => {
            console.log("preloading image:", img);
            const el = document.createElement("img");
            el.src = this.config.imgs[this.currentImgIndex];
    ...
    createSelectors() {
        ...
        leftCaret.style.transform = "rotate(90deg)";

        console.log(leftCaret);
        ...
        rightCaret.style.transform = "rotate(270deg)";
